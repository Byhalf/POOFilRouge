...
*<ul>
*<li>Un est le jeu souhaité (nim, morpion, puissance4)</li>
*<li>Et les 2 autres sont les joueurs, ils peuvent etre humain, random ou robot (MinMax)</li>
*</ul>
*</p>
*/
public class Main{
  public static void main(String [] args) throws IllegalArgumentException{
    ...
    for(int i = 0;i < 3;i++){
      String arg = args[i];
      player = null;
      if(arg.equals("nim") || arg.equals("morpion") || arg.equals("puissance4")){
        choiceGame = arg;
        ...
        System.out.println("Choisissez le nombre de seconde maximun que le robot va réflechir");
        System.out.println("WARNING! Si le robot n'as pas eu le temps de trouver un coup dans le temps impartie,") ;
        System.out.println("il prendra quelque seconde de plus pour en choisir un");
        int secondes = -1;
        while(secondes < 0) {
          try {
